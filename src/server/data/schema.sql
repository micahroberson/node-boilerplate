...
CREATE TABLE logs.user_sessions (
  id VARCHAR(32) NOT NULL DEFAULT generate_object_id() PRIMARY KEY,
  ref_id VARCHAR(32),
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  action TEXT NOT NULL CHECK (action in ('insert', 'update', 'delete')),
  old_values JSONB,
...
INSERT INTO migrations (name, run_on) VALUES ('/20160911224322-add-users', CURRENT_TIMESTAMP);
INSERT INTO migrations (name, run_on) VALUES ('/20160912170437-add-user-sessions', CURRENT_TIMESTAMP);
